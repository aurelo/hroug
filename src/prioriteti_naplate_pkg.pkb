...
--------------------------------------------------------------------------------
   ...
   return strategije_naplate_tt
   is
      v_potrazivanja_po_prioritetu   strategije_naplate_tt
                                        := strategije_naplate_tt ();
...
--------------------------------------------------------------------------------
   function get_potrazivanja_po_prioritetu (
      p_potrazivanja_tab in strategije_naplate_tt
   )
...
--------------------------------------------------------------------------------
   function sortiraj (
      ...
      return potrazivanja_tt
   is
      v_instance_strategije_naplate   strategije_naplate_tt;
      v_sortirana_potrazivanja_tab    potrazivanja_tt;
   begin
